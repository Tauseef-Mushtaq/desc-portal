...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    axios.get('/api/admin/stats').then(({ data }) => setStats(data.stats)).finally(() => setLoading(false));
  }, []);
      ...
      <div className="px-4 md:px-8 py-8 max-w-portal mx-auto pb-24 lg:pb-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-on-surface-variant text-sm mt-1">Manage and process citizen service requests</p>
          </div>
